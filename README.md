...
volumes:
  ...
  postgresql_data:
```
After Setup the SonarQube, you should get the following screen on http://IP-ADDRESS:9000
...
```
 ...
 After Setup the JFrog Artifactory, you should get the following screen on http://{yourinstanceip}:8081
...
You can refer this link to install the plugins also [JFrog Plugins](https://plugins.jenkins.io/jfrog/)
...
**Once you build the code and run the pipeline. You will find the file in your Artifactory.** 
